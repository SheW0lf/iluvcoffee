...
async function bootstrap() {
    ...
    app.useGlobalPipes(
        new ValidationPipe({
            ...
            transformOptions: {
                enableImplicitConversion: true // no longer need to use the Type decorator to indicate the prop types, instead they will be assigned by the TS type definitions
            }
        }),
    );
