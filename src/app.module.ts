...
@Module({
  imports: [CoffeesModule, TypeOrmModule.forRoot({
    ...
    port: 6432, // external port database is running on. see docker-compose.yml
    ...
    database: 'postgres', // default database name. If db name not specified in docker-compose.yml, this name is the same as the username specified above
